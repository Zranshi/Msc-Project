...
# That is, suppose there is such an operator p, 0 p 0 = 1, 0 p 2 = 0, and all others are 2.
# Then there is an operator q, and 0 and 1 in all operation rules of q are swapped.
# Then we can get The specific operation rules of q: 1 p 1 = 0, 1 p 2 = 1, and all other operations are 2.
